...
data_gen = data_swat.DataSwat(window_length = 50, ratio = 1, window_stride=50, error_window_length=25)
...
#
tcn_ae.fit(train_X, train_X, batch_size=64, epochs=5, verbose=1)
